...
<!-- <img v-bind:src="'http://image.tmdb.org/t/p/w154/'+moviesTopList[0].poster_path" alt='movie poster'/> -->
 ...
 <b-carousel-slide>
        <img
          ...
          width="840"
          height="230"
          v-bind:src="'http://image.tmdb.org/t/p/w154/' + moviesTopList[3].poster_path"
          alt="image slot"
        />
      </b-carousel-slide>
 <b-carousel-slide>
        <img
          ...
          width="840"
          height="230"
          v-bind:src="'http://image.tmdb.org/t/p/w154/' + moviesTopList[4].poster_path"
          alt="image slot"
        />
      </b-carousel-slide>
...
export default {
    ...
    methods: {
        fetchData() {
            axios
                .get('https://api.themoviedb.org/3/movie/upcoming?api_key=ff219f24cf866a850c34d6a49bdaf425&language=en-US&page=1&region=US')
                .then((resp) => {
